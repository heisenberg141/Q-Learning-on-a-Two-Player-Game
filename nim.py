...
class NimAI():
    ...
    def __init__(self, alpha=0.6, epsilon=0.3):
        """
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        where `old value estimate` is the previous Q-value, Q-value fo
...
def train(n):
    ...
    print(f"I have stored {len(player.q)} states.Bring it on!")
    return player
